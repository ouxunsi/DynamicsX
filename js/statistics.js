$(function() {
    ...
    function statistics_click(e) {
        ...
        var uid = getUid();
        var pId = "";
        var url = "http://log.ouxunsi.com/click.gif?key=" + key + "&hf=" + hf
                  + "&vi=" + vi
                  + "&tc=" + tc
...
//	var url = "http://log.ouxunsi.com/page.gif?;"//看一下之前的page代码是怎么写的
//	new Image().src = url;
});
(function(){function g(a){if(window.sessionStorage)return window.sessionStorage.getItem(a);return null}function f(a,b){var c=new Image,d="zcool_log_"+Math.floor(Math.random()*2147483648).toString(36);window[d]=c;c.onload=c.onerror=c.onabort=function(){c.onload=c.onerror=c.onabort=null;c=window[d]=null;b&&b(a)};c.src=a}function h(){this.valueStack={};this.beginAnalyse()}var k=navigator.cookieEnabled,l=navigator.javaEnabled(),m=navigator.language||navigator.browserLanguage||navigator.systemLanguage||
                                                                                                                                                                                                                                                                                                                                                                                                                                              navigator.userLanguage||"",n=window.screen.width+"x"+window.screen.height,e=["ouxunsi.com"];/msie (\d+\.\d+)/i.test(navigator.userAgent);var j=["uid","sr","ln","ca","ja","re","lo","rand","v"];h.prototype={init:function(){var a=this.getData();this.valueStack.v="1.0.5";this.valueStack.uid=a;this.valueStack.re=document.referrer;this.valueStack.sr=n;this.valueStack.ln=m;this.valueStack.ca=k?1:0;this.valueStack.ja=l?1:0;this.valueStack.lo=window.location.href},beginAnalyse:function(){try{this.init(),
    this.sendLogToServer("http://log.ouxunsi.com/page.gif?")}catch(a){var b=[];b.push("n="+encodeURIComponent(a.name));b.push("m="+encodeURIComponent(a.message));b.push("r="+encodeURIComponent(document.referrer));f("http://log.ouxunsi.com/"+b.join("&"))}},checkHostName:function(a,b){a=a.replace(/:\d+/,"");b=b.replace(/:\d+/,"");pos=a.indexOf(b);return pos>-1&&pos+b.length==a.length},getCookieDomain:function(){var a=window.location.hostname;for(i=0;i<e.length;i++)if(this.checkHostName(hostName,e[i]))return e.replace(/(:\d+)?[\/\?#].*/,
