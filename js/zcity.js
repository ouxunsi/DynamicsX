            ...
            var countryCityPlug = {
                render: function () {
                    ...
                    $('.js-tab-city').on('click', function () {
                       ...
                       //  $('.js-city-covers').html('<div id="ajaxfeed-loading" style="text-align: center;"><img src="http://' + staticDomain + '/z/images/common/page_loading.gif"></div>');
                        if(flag){
                            flag = false;
                            $.ajax({
                                type: "GET",
                                url: "json/getAll.json",
                                xhrFields: {
...
// $.ajax({
//             type: "GET",
//             url: "http://" + zMainDomain + "/city/getAll",
//             xhrFields: {
//                 withCredentials: true
//             },
//             crossDomain: true,
...
//             success: function (data) {
//                 // console.log(data);
//                 var hotCity = data.data.china.hotCity;
//                 var byProvince = byProvince

//                 str += "<div class=\"left city-panel-covers\">" +
//                     "<div class=\"cin-city-cover\">" +
...
//                                 "<span class=\"city-province-title city-select\">按省份</span>" +
//                                 "<span class=\"city-city-title\">按城市</span>" +
//                             "</div>" +
//                         "</section>" +
