    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="' +
                    ...
                    '<div class="city-select province scrollbar" data-count="province"></div>' +
                    (this.includeDem('city') ? '<div class="city-select city scrollbar" data-count="city"></div>' : '') +
        ...
        getWidthStyle: function (w, dropdown) {
            if (this.options.responsive && !$.isNumeric(w)) {
                ...
                return 'min-width:' + (dropdown ? Math.max(232, w) : w) + 'px;';
            }
        },
            ...
            this.$dropdown.find('.city-select')
                .each(function () {
                    ...
                    if (item) {
                        ...
                        // else{
                        //     text = ($(this).hasClass('city') ? '' : '') + '<span class="select-item" data-count="' +
                        //     type + '" data-code="' + "47" + '" >' + "北京" + '</span>'
                        // }
